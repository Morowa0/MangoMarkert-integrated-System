...
<body style="background-image: url(images/bg_image_1.jpg); " >
...
<center>
    <table>
        <tr>
            <th colspan="5">
                <h1 class="h1">Our Mango Varieties</h1>
            </th>
        </tr>
        <tr class="th">
            <th style="width: 15%;">Type Name</th>
            <th style="width: 45%;">Sample Image</th>
            <th style="width: 15%;">Payment Processing</th>
            <th style="width: 10%;">Price (Ksh/Kg)</th>
            <th style="width: 15%;">Action</th>
        </tr>
        @foreach($product as $item)
        <tr>
            <td>{{ $item->name }}</td>
            <td><img height="200" width="250" src="mangotypes/{{ $item->image }}" alt="Sample image of {{ $item->name }}"></td>
            <td>{{ $item->duration }}</td>
            <td>{{ $item->price }}</td>
            <td><a class="btn btn-success" href="{{ url('/updateprice', $item->id) }}">Update Price</a></td>
        </tr>
        @endforeach
    </table>
</center>
