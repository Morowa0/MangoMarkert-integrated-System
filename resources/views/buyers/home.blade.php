...
<section  style="background-color:yellowgreen ">
    <center>
    <h2 style="color: black; padding-top:60px; font-size:4em ">Welcome to Integrated Mango Market Space</h2>
    <p style="color: red; font-size:2em "><b>The space you easily find a market for your mango fruits.</b></p>
    <marquee>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/bg_image_1.jpg" alt="First slide">
            </div>
