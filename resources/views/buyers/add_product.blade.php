...
<div class="alert alert alert-success" id="alert" style="font-size: 30px; position: absolute; top: 10; left: 50%; transform: translateX(-50%);">
...
<form action="{{url('addtype')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <h4 style="margin-bottom: 1px; text-align:center;">ADD TYPES OF MANGOES</h4>
    ...
    <div style="padding:5px">
        ...
        <input type="text" name="typename" placeholder="Enter mango type name">
    </div>
    <div style="padding:5px">
        <label>Price in Ksh/Kg:</label>
        <input type="text" name="price" placeholder="price of 1Kg of this mango type">
    </div>
    <div style="padding:5px">
        <label>Payment processing:</label>
        <input type="text" name="duration" placeholder="Enter the time it takes to process payment">
    </div>
    <div style="padding:5px">
        <label>Sample Image:</label>
        <input type="file" name="image" placeholder="upload sample ">
    </div>
