...
<center>
    @if($errors->any())
    <div class="alert alert alert-danger" id="alert" style="font-size: 16px; position: absolute; top: 10; left: 50%; transform: translateX(-50%);">
        <ul>
...
<div class="print-button no-print">
    ...
    <table>
        <thead>
            <tr>
                <th colspan="6">
                    <h1 class="h1"> Pending Order(s)</h1>
                </th>
            </tr>
            <tr>
                ...
                <th style="width: 15%;">Price in Ksh/Kg</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ url('approve.order', $item->id) }}" method="POST">
                        @csrf
