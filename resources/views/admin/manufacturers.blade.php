...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="mb-4" style=" text-align: center ;">Manufacturers Management Centre</h1>
...
<table class="table table-bordered" style="border: 10px Cyan;">
    ...
    <tr style="color: white;">
        ...
        <th style="color: white;">Daily Limit</th>
    ...
    @foreach($users as $user)
        <tr>
            ...
            <td style="color: white;">
                <form action="{{ route('users.updateDailyLimit', $user->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('PUT')
                    <input type="number" name="daily_limit" value="{{ $user->daily_limit }}" class="form-control d-inline" style="width: 100px; color:white;">
